/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5cd928b2146213d9a4ee3e029e641b44)
// Runtime types generated with workerd@1.20250902.0 2025-08-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		DAYTONA_SANDBOX_MANAGER: DurableObjectNamespace<import("./src/index").DaytonaSandboxManagerDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DAYTONA_API_URL" | "ENVIRONMENT" | "DAYTONA_API_KEY" | "ANTHROPIC_API_KEY">> {}
}
